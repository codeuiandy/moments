// import { fontBold, fontRegular, fontSemi, fontMedium } from "@components/theme/";
import Animated, { Easing } from "react-native-reanimated";
import React, { useState, useEffect } from "react";
import { View, Text, TouchableOpacity, Dimensions, PixelRatio, ScrollView, ImageBackground, StatusBar, RefreshControl, TextInput, StyleSheet } from "react-native";
...
interface PaddingProps {
  ...
  paddingHorizontalPercent?: string;
}
...
interface Container {
  ...
  height?: number;
  width?: number;
  verticalAlignment?: "flex-start" | "flex-end" | "center" | "space-between" | "space-around";
  horizontalAlignment?: "flex-start" | "flex-end" | "center" | "space-between" | "space-around";
      ...
      style={[
        {
          ...
          justifyContent: props.dir === "row" ? props.horizontalAlignment : props.verticalAlignment,
          alignItems: props.dir === "row" ? props.verticalAlignment : props.horizontalAlignment,
          backgroundColor: props.elevation > 0 && props.backgroundColor == null ? "#fff" : props.backgroundColor,
          ...
          paddingHorizontal: Width(props.paddingHorizontal) || props.paddingHorizontalPercent,
          ...
          left: Width(props.left), //added this
          right: Width(props.right), //added this
          top: Height(props.top), //added this
          bottom: Height(props.bottom), //added this
        },
        props.style,
      ]}>
      {props.children}
...
export const Avatar = ({ ...props }: Avatar & MarginProps & PaddingProps & BorderWidth & BorderRadiusProps) => {
  return (
    <View
      style={[
        // @ts-ignore
...
export const ScrollAreaRefresh = ({ ...props }: ScrollAreaRefresh) => (
  <ScrollView
    refreshControl={<RefreshControl onRefresh={props.onRefresh} refreshing={props.refreshing || false} />}
    horizontal={props.horizontal}
    showsVerticalScrollIndicator={false}
    showsHorizontalScrollIndicator={false}
    contentContainerStyle={{ flexGrow: props.flexGrow }}>
...
interface ImageWrapProps {
  ...
  backgroundColor?: any;
  overlayColor?: any;
  horizontalAlignment?: "center" | "flex-start" | "flex-end" | "space-between" | "space-around" | "space-evenly";
  verticalAlignment?: "center" | "flex-start" | "flex-end" | "space-between" | "space-around" | "space-evenly";
  position?: "absolute" | "relative";
...
export const ImageWrap = ({ ...props }: ImageWrapProps & BorderRadiusProps & MarginProps & PaddingProps & BorderWidth) => {
  return (
    <ImageBackground
      ...
      <Container flex={props.flex} backgroundColor={props.overlayColor}>
        {props.children}
      </Container>
    </ImageBackground>
  );
...
interface TouchWrapProps {
  ...
  horizontalAlignment?: "flex-start" | "flex-end" | "center" | "stretch" | "baseline";
  borderRadius?: number;
...
export const TouchWrap = ({ ...props }: TouchWrapProps & PaddingProps & BorderWidth & MarginProps) => {
  return (
    <TouchableOpacity
  ...
  return (
    <>
      <SafeAreaView
        ...
        <StatusBar translucent={true} backgroundColor={props.barColor} barStyle={"dark-content"} />
        <Container
          flex={1}
  ...
  return (
    <Container
      ...
      <TextInput
        ...
        onBlur={props.onBlur}
        editable={props.editable} //added this
        ...
        style={[
          ...
          styles.input,
          {
            ...
            fontFamily: props.fontFamily || family.SFProTextLight,
